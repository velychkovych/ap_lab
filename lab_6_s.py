...
article1 = article(date=datetime.now(), header='article1', textOfArticle='someText1', idAuthor=1)
modification1 = modification(dateOfModification=datetime.now(), idUser=1, idArticle=1)
